...
public class Superstructure extends SubsystemBase {
    ...
    private void shootCalibrating() {
        setWantedSubsystemStates(Intake.INTAKE_STATE.IDLING_STOWED, Feeder.FEEDER_STATE.IDLING,
    ...
    private void shootingAutomaticHub() {
        setWantedSubsystemStates(Intake.INTAKE_STATE.INTAKE, Feeder.FEEDER_STATE.FAST_FEEDING,
    ...
    private void intakeLifting() {
        setWantedSubsystemStates(Intake.INTAKE_STATE.IDLING_STOWED, Feeder.FEEDER_STATE.SLOW_FEEDING,
    ...
    private void intakeDropping() {
        setWantedSubsystemStates(Intake.INTAKE_STATE.IDLING_DEPLOYED, Feeder.FEEDER_STATE.SLOW_FEEDING,
            Gatekeeper.GATEKEEPER_STATE.CLOSED, Shooter.SHOOTER_STATE.IDLE,
            Climber.CLIMBER_STATE.IDLING);
    }

    private void intaking() {
        setWantedSubsystemStates(Intake.INTAKE_STATE.INTAKE, Feeder.FEEDER_STATE.SLOW_FEEDING,
            Gatekeeper.GATEKEEPER_STATE.CLOSED, Shooter.SHOOTER_STATE.IDLE,
            Climber.CLIMBER_STATE.IDLING);
    }
